  ...
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        ...
        "fixed inset-0 z-(--z-dialog-backdrop) bg-scrim transition-opacity duration-(--duration-fast) data-ending-style:opacity-0 data-starting-style:opacity-0",
        className,
      )}
      {...props}
    />
