...
- **Human-in-the-loop by default.** `RestartDockerService`, `DockerBash`, `RestartK8sWorkload` and `K8sBash` require explicit approval. Reads run automatically so the agent can investigate without waiting on you.
